...
export default function Contact() {
  ...
  useEffect(() => {
    ...
    Traffic 
    ? Contact.addOverlayMapTypeId(kakao.maps.MapTypeId.TRAFFIC)
    : Contact.removeOverlayMapTypeId(kakao.maps.MapTypeId.TRAFFIC) 
